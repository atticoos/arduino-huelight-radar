...
module.exports = (function () {
  ...
  HueControl.prototype.turnOn = function () {
    var state = LightState.create().on().bri(255).rgb(255,255,255);
  ...
  HueControl.prototype.blinkRed = function () {
    var red = LightState.create().rgb(255, 0, 0).bri(255),
        briDown = LightState.create().bri(0);
    return this.api.setLightState(this.lightId, red).then(function () {
      return delay(500);
    }).then(function () {
      return this.api.setLightState(this.lightId, briDown);
    }.bind(this)).then(function () {
      return delay(500);
    });
  };

  HueControl.prototype.blinkGreen = function () {
    var green = LightState.create().rgb(0, 255, 0).bri(255),
        briDown = LightState.create().bri(0);
    return this.api.setLightState(this.lightId, green).then(function () {
      return delay(500);
    }).then(function () {
      return this.api.setLightState(this.lightId, briDown);
    }.bind(this)).then(function () {
  ...
  HueControl.prototype.blink = function () {
    var red = LightState.create().rgb(255, 0, 0),
        ...
        briDown = LightState.create().bri(0),
        briUp = LightState.create().bri(255);
    return this.turnOn().then(function () {
      ...
      return this.api.setLightState(this.lightId, briUp);
      return this.turnOn();
    }.bind(this)).then(function () {
      return delay();
    }).then(function () {
