...
module.exports = (function () {
  ...
  function SerialPortControl (port, baudRate, debugMode) {
  ...
  SerialPortControl.prototype.queue = function (data) {
    ...
    if ((!this.lastEmit && this.sampleBuffer.length > 50) ||
  ...
  SerialPortControl.prototype.getAverageDistance = function () {
    return this.sampleBuffer.reduce(function (min, currentValue) {
      if (!min) {
        min = currentValue;
      }
